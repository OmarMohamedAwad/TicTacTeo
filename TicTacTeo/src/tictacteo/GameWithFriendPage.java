...
public class GameWithFriendPage extends AnchorPane {
    ...
    public void setDesignProperty() {
        ...
        titleDropShadow.setColor(Color.valueOf("#1b1a1a"));
        ...
        playAginButton.setTextFill(Color.valueOf("#f8f7f7"));
        ...
        xTurnLabel.setTextFill(Color.WHITE);
